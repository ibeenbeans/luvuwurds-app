...
const styles = StyleSheet.create({
  ...
  backBtnText:    { color: '#b89f84', fontSize: 12, fontFamily: 'Georgia', letterSpacing: 1 },
  list:           { paddingHorizontal: 24, paddingBottom: 40 },
  empty:          { alignItems: 'center', marginTop: 80 },
  emptyText:      { color: '#7a6450', fontSize: 16, fontStyle: 'italic', fontFamily: 'Georgia', marginBottom: 6 },
  emptyHint:      { color: '#7a6450', fontSize: 13, fontFamily: 'Georgia' },
  ...
  removeBtnText:  { color: '#7a6450', fontSize: 11, letterSpacing: 1.5, fontFamily: 'Georgia' },
});
