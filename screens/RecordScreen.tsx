...
const styles = StyleSheet.create({
  ...
  resetTxt:       { color: '#5a4a3a', fontSize: 11, fontFamily: 'Georgia', textDecorationLine: 'underline' },
  ...
  recordingTip:   { color: '#7a6a58', fontSize: 13, fontFamily: 'Georgia', fontStyle: 'italic' },
